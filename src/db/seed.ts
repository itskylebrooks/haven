...
export const seedIfEmpty = async () => {
  ...
  const users: DBUser[] = [
    { id: 'itskylebrooks', name: 'Kyle Brooks', handle: '@itskylebrooks', bio: 'learning to slow down', circlesCount: 42, signalsCount: 8, visibility: 'public' },
    { id: 'lena', name: 'Lena', handle: '@lena', bio: 'photographer of quiet things', visibility: 'public' },
    { id: 'milo', name: 'Milo', handle: '@milo', bio: 'designer of invisible systems', visibility: 'public' },
    { id: 'ava', name: 'Ava', handle: '@ava', bio: 'writer and listener', visibility: 'public' },
    { id: 'eli', name: 'Eli', handle: '@eli', bio: 'sound engineer of silent rooms', visibility: 'public' },
    { id: 'noah', name: 'Noah', handle: '@noah', bio: 'curating small, steady communities', visibility: 'public' },
    { id: 'sage', name: 'Sage Marin', handle: '@sage', bio: 'cartographer of attention', visibility: 'public' },
    { id: 'ravi', name: 'Ravi Kapoor', handle: '@ravi', bio: 'tea, typography, and tiny tools', visibility: 'public' },
    { id: 'faye', name: 'Faye Liu', handle: '@faye', bio: 'collecting gentle thunderstorms', visibility: 'public' },
    { id: 'orion', name: 'Orion Hale', handle: '@orion', bio: 'night-walker, sky listener', visibility: 'public' },
    { id: 'nora', name: 'Nora Ellis', handle: '@nora', bio: 'urban naturalist; moss maximalist', visibility: 'public' },
    { id: 'juno', name: 'Juno Park', handle: '@juno', bio: 'software symphonies and soft mornings', visibility: 'public' },
    { id: 'aria', name: 'Aria Wilde', handle: '@aria', bio: 'notes between notes', visibility: 'public' },
    { id: 'sol', name: 'Sol Rivera', handle: '@sol', bio: 'sunrise chaser, sunset saver', visibility: 'public' },
    { id: 'basil', name: 'Basil Stone', handle: '@basil', bio: 'plants have personalities', visibility: 'public' },
    { id: 'ivy', name: 'Ivy Rhodes', handle: '@ivy', bio: 'storyteller in lowercase', visibility: 'public' },
    { id: 'cato', name: 'Cato Wynn', handle: '@cato', bio: 'maps, margins, and meaning', visibility: 'public' },
    { id: 'paz', name: 'Paz Méndez', handle: '@paz', bio: 'quiet tech for loud worlds', visibility: 'public' },
    { id: 'uma', name: 'Uma Das', handle: '@uma', bio: 'curious about everything slow', visibility: 'public' },
    { id: 'kian', name: 'Kian Moss', handle: '@kian', bio: 'audio tinkerer; room tone enjoyer', visibility: 'public' },
    { id: 'sora', name: 'Sora Kim', handle: '@sora', bio: 'paper crafts and pixel dust', visibility: 'public' },
    { id: 'remy', name: 'Remy Cho', handle: '@remy', bio: 'the tiniest optimizations', visibility: 'public' },
    { id: 'tala', name: 'Tala Noor', handle: '@tala', bio: 'desert rain archivist', visibility: 'public' },
    { id: 'zeno', name: 'Zeno Quinn', handle: '@zeno', bio: 'paradoxes and porch coffee', visibility: 'public' },
    { id: 'mina', name: 'Mina Farah', handle: '@mina', bio: 'letters to the future self', visibility: 'public' },
    { id: 'arlo', name: 'Arlo Vance', handle: '@arlo', bio: 'bikes, bread, and balance', visibility: 'public' },
    { id: 'cleo', name: 'Cleo Hart', handle: '@cleo', bio: 'art school dropout; color theorist', visibility: 'public' },
    { id: 'zev', name: 'Zev Adler', handle: '@zev', bio: 'slow computing advocate', visibility: 'public' },
    { id: 'yara', name: 'Yara Sousa', handle: '@yara', bio: 'front porch philosopher', visibility: 'public' },
    { id: 'indie', name: 'Indie Moore', handle: '@indie', bio: 'independent as advertised', visibility: 'public' },
    { id: 'lotus', name: 'Lotus Tran', handle: '@lotus', bio: 'water, wind, and whitespace', visibility: 'public' },
    { id: 'cal', name: 'Cal Rivers', handle: '@cal', bio: 'rest is productive', visibility: 'public' },
    { id: 'dune', name: 'Dune Ortega', handle: '@dune', bio: 'sand library librarian', visibility: 'public' },
    { id: 'mara', name: 'Mara Zaid', handle: '@mara', bio: 'small talk, big heart', visibility: 'public' },
    { id: 'odin', name: 'Odin Rue', handle: '@odin', bio: 'maker of simple tools', visibility: 'public' },
    { id: 'piper', name: 'Piper Nash', handle: '@piper', bio: 'gentle provocations', visibility: 'public' },
